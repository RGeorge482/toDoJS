...
//add Templates Literals for head title
const myTitle = (
`To Do List`
)
...
// add Template Literals for welcome template
const welcomePage = (
`<div>
  <h1>To Do List</h1>
  <p>This is a To Do app where users can track their tasks.</p>
  <br>
  <div id="btn_div">
...
// add Template Literals for Sign Up template
const userDiv = (
`<form name="signUpForm" id="signUpForm">
  ...
  <input type="text" id="newEmailAddress"><br>
  ...
  <input type="submit" id="newUserSubmit" class="submitButton"><br>
  <label class="errorMessage">Error</label>
</form>`
)

const newUserDiv = document.getElementById("newUserDiv");
newUserDiv.innerHTML = userDiv;

// add Template Literals for Log in template
const logDiv = (
`<form name="logInForm" id="logInForm">
  <h1>Login</h1><br>
  <label>Email Address:</label><br>
  <input type="text" id="loginEmailAddress"><br>
  <label>Password:</label><br>
  <input type="password" id="loginPassword"><br><br>
  <input type="submit" id="existingUserSubmit" class="submitButton"><br><br>
  <label class="errorMessage">Error</label>
</form>`
)

const loginDiv = document.getElementById("loginDiv");
loginDiv.innerHTML = logDiv;

// add Template Literals for Dashboard template
const myDashboard1 = (
`<div>
  ...
  <div id="createNewList">
     <button id="createToDoList">Create New To-Do List</button>
  </div>
</div>`
)

const dashboard1 = document.getElementById("dashboard");
dashboard1.innerHTML = myDashboard1;

// add Template Literals for list template
myEditList1 = (
`<div>
  <h1 id="listNameLabel">To Do List</h1>
  <ul id="toDoList">
  </ul>
  <div id="toDoListActions">
...
const editList1 = document.getElementById("editList");
editList1.innerHTML = myEditList1;
...
function loadDashboard() {
 ...
 if (userData === null) {
     ...
     if (retrievedStorage === null || retrievedStorage === undefined) {
         ...
         li.appendChild(document.createTextNode("No To Do lists created."));
         ul.appendChild(li);
